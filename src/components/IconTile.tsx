...
const IconTile: React.FC<Props> = ({ item }) => {
	...
	return (
		<div className="bg-primary/10 border-primary/20 relative flex w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-md border p-4 text-sm text-white shadow-lg hover:bg-primary/12 hover:scale-102 transition-all">
