...
const PhilippinePesoIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(PhilippinePesoIcon);
export { icon as PhilippinePesoIcon };
