...
const CornerUpRightIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(CornerUpRightIcon);
export { icon as CornerUpRightIcon };
