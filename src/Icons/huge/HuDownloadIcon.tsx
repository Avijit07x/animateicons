...
export interface HuDownloadIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface HuDownloadIconProps extends HTMLMotionProps<"div"> {
 size?: number;
 duration?: number;
 isAnimated?: boolean;
}

const HuDownloadIcon = forwardRef<HuDownloadIconHandle, HuDownloadIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
...
HuDownloadIcon.displayName = "HuDownloadIcon";
export { HuDownloadIcon };
