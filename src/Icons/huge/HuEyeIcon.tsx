...
export interface HuEyeIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface HuEyeIconProps extends HTMLMotionProps<"div"> {
 size?: number;
 duration?: number;
 isAnimated?: boolean;
}

const HuEyeIcon = forwardRef<HuEyeIconHandle, HuEyeIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
...
HuEyeIcon.displayName = "HuEyeIcon";
export { HuEyeIcon };
