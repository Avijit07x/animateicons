...
export interface HuCheckCheckIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface HuCheckCheckIconProps extends HTMLMotionProps<"div"> {
 size?: number;
 duration?: number;
 isAnimated?: boolean;
}

const HuCheckCheckIcon = forwardRef<
 HuCheckCheckIconHandle,
 HuCheckCheckIconProps
>(
 (
  {
   onMouseEnter,
...
HuCheckCheckIcon.displayName = "HuCheckCheckIcon";
export { HuCheckCheckIcon };
