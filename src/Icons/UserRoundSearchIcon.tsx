...
const UserRoundSearchIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(UserRoundSearchIcon);
export { icon as UserRoundSearchIcon };
