...
const UserRoundCheckIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(UserRoundCheckIcon);
export { icon as UserRoundCheckIcon };
