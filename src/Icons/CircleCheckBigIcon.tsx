...
const CircleCheckBigIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(CircleCheckBigIcon);
export { icon as CircleCheckBigIcon };
