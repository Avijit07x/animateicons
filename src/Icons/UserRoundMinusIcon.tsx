...
const UserRoundMinusIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(UserRoundMinusIcon);
export { icon as UserRoundMinusIcon };
