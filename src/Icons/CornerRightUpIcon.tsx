...
const CornerRightUpIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(CornerRightUpIcon);
export { icon as CornerRightUpIcon };
