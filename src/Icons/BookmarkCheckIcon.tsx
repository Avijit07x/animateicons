...
const BookmarkCheckIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(BookmarkCheckIcon);
export { icon as BookmarkCheckIcon };
