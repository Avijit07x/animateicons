...
const ChevronsRightIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(ChevronsRightIcon);
export { icon as ChevronsRightIcon };
