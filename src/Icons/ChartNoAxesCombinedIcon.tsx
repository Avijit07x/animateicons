...
const ChartNoAxesCombinedIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(ChartNoAxesCombinedIcon);
export { icon as ChartNoAxesCombinedIcon };
