...
const BookOpenCheckIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(BookOpenCheckIcon);
export { icon as BookOpenCheckIcon };
