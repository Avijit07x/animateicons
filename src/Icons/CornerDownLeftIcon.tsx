...
const CornerDownLeftIcon = forwardRef<AnimatedIconRef, AnimatedIconProps>(
	(
...
const icon = withAnimatedIconWrapper(CornerDownLeftIcon);
export { icon as CornerDownLeftIcon };
