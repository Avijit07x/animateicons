...
function main() {
	...
	// A tiny, tree-shakeable constant so UI copy ("All N icons") stays in sync
	// without importing the icon barrel or the full catalog into the bundle.
	const countsPath = path.join(ROOT, "lib", "icon-count.generated.ts");
	const countsFile = `// AUTO-GENERATED by \`pnpm gen:catalog\`. Do not edit by hand.
export const ICON_COUNTS = {
	lucide: ${catalog.libraries.lucide},
	huge: ${catalog.libraries.huge},
	total: ${catalog.total},
} as const;
`;
	fs.writeFileSync(countsPath, countsFile, "utf8");

	console.log("✅ Catalog generated successfully.");
	console.log(
		`Total icons: ${catalog.total} (lucide: ${catalog.libraries.lucide}, huge: ${catalog.libraries.huge})`,
	);
	console.log(`Written: public/r/catalog.json, lib/icon-count.generated.ts\n`);
}
