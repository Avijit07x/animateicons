 ...
 * action row:
 *
 *   live AnimateIcons tile: gap-2 p-4, border-r + border-b (grid lattice)
 *   icon button:            size-12 rounded-md
...
const IconTileSkeleton: React.FC = () => {
	return (
		<div className="border-border/60 relative flex w-full flex-col items-center justify-center gap-2 overflow-hidden border-r border-b p-4 text-sm">
			{/* Icon button area - matches IconTile's size-12 rounded-md click target. */}
			<div className="size-12 animate-pulse rounded-md bg-white/8" />
