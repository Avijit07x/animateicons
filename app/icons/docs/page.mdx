...
<Badge>Recommended</Badge> Best for most apps. One install, all
{ICON_COUNTS.total} icons available.
...
<Callout type="tip">
	Icons animate on hover out of the box, no extra wiring. Pass `size`, `color`,
	or any prop to customize.
</Callout>
