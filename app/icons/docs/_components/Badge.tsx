...
const Badge: React.FC<{ children: ReactNode }> = ({ children }) => (
	<span className="mr-2 inline-block rounded-sm border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-0.5 align-middle text-xs font-semibold text-emerald-400 [&_p]:m-0! [&_p]:inline [&_p]:leading-none [&_p]:text-inherit">
		{children}
	</span>
);
